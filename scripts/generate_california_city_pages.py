...
<head>
  ...
  <title>$city Courier & Delivery Services | Cordova Courier</title>
  <meta name=\"description\" content=\"Fast, professional courier and freight delivery in $city, California and surrounding areas.\" />
...
<div class=\"hero-section\">
  <nav aria-label=\"Breadcrumb\" class=\"breadcrumb-nav\">
    <ul class=\"breadcrumb\">
      ...
      <li><a href=\"/service-areas/usa/california\">California</a></li>
      <li>$city</li>
    </ul>
  </nav>
  <h1>$city, CA Courier & Delivery Services</h1>
  <p>Reliable same-day, freight, and medical deliveries in $city and across California.</p>
  <div class=\"cta-buttons\">
    <a href=\"/quote\" class=\"btn\">Request a Quote</a>
  </div>
</div>
<section class=\"services-row\">
  <h2>Our $city Delivery Solutions</h2>
  <div class=\"icons\">
...
<section id=\"reviews\" class=\"grid-section\">
  <h2>Trusted in $city</h2>
  <div class=\"state-grid\">
    <div>
      <strong>⭐ ⭐ ⭐ ⭐ ⭐</strong><br />
      “Cordova Courier keeps our $city operations running smoothly.”<br />
      <em>– Local Business Owner</em>
    </div>
    <div>
      <strong>⭐ ⭐ ⭐ ⭐ ⭐</strong><br />
      “Fast deliveries across California.”<br />
...
def main():
    cities = []
    with open('/tmp/ca_cities.txt') as f:
        for line in f:
            slug, name = line.strip().split('|')
            cities.append((slug, name))
    for slug, name in cities:
        dir_path = Path(f'service-areas/usa/california/{slug}')
        dir_path.mkdir(parents=True, exist_ok=True)
        with open(dir_path / 'index.html', 'w') as f:
            f.write(TEMPLATE.safe_substitute(city=name))
